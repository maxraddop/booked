...
$conf['settings']['admin.email'] = 'mayur@poddu.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://booked';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['inactivity.timeout'] = '3600';     			// minutes before the user is automatically logged out
...
$conf['settings']['database']['user'] = 'schedule_user';        // database user with permission to the booked database
